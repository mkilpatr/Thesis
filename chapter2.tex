...
\centering
	\includegraphics[width=0.50\textwidth]{T2tt_limits_summary_cms.png}
 	\caption[T2tt Limits for all decay modes from CMS]{Limits for the mass parameter space for T2tt decays using results from all the analysis in CMS. With a current limit of 1.05 TeV to 1.2 TeV for a minimal neutralino mass \cite{noauthor_https://twiki.cern.ch/twiki/bin/view/cmspublic/physicsresultssus_nodate}.}
 	\label{T2ttCMSAll} 
\end{figure}
...
\centering
	\includegraphics[width=0.60\textwidth]{ATLAS_topsquark_results.pdf}
 	\caption[T2tt Limits for all decay modes from ATLAS]{Limits for the mass parameter space for top squark decays using results from all the analysis in ATLAS. With a current limit of 700 GeV to 1.0 TeV for a minimal neutralino mass \cite{the_atlas_collaboration_susy_2019}.}
 	\label{T2ttATLASAll} 
\end{figure}

...
\hline
 ...
 \hline
\end{tabular}
\caption{A table showing all forms of the fermion currents. These can be symmetric under parity transformation in all or some components.}
...
\begin{figure}
	...
	\includegraphics[width=0.75\textwidth]{QEDRules.png}
 	\caption{The possible feynman diagrams in QED. The $e$ can be replaced with any spin-$1/2$ charged particle. We see that the electron and photon can propagate freely in space or a vertex with one photon and a particle-antiparticle pair is allowed.}
 	\label{QEDRules} 
\end{figure}
...
\begin{figure}[!htb]
	...
	\endminipage\hfill
	\caption{The possible feynman diagrams in QCD. Each vertex needs to be color neutral. Here is just an example of a red-blue vertex. QCD also includes a 3- and 4-vertex with gluons.}
 	\label{QCDRules} 
\end{figure}
...
\begin{figure}
	...
	\includegraphics[width=0.5\textwidth]{Quark_weak_interactions.png}
 	\caption{A gramatical representation to show the couplings for Weak interactions, known as the Cabibbo-Kobayashi-Maskawa Matrix. }
...
where $g_W$ and $g_W^{\prime}$ are the Weak force coupling constants while $W_\mu^a$ and $B_\mu$ are four gauge bosons and can be the possible candidates for $\W^\pm$, \Z and $\gamma$.  Just like the above descriptions the fields need to transform along with the wavefuntions and derivatives. These transformations are,
...
\begin{table}
	...
	\includegraphics[width=0.7\textwidth]{ChiralSupermultiplets.png}
 	\caption{The chiral supermultiplets of the MSSM. Spin-0 fields are complex scalars and spin-$1/2$ fields are left-handed two component Weyl fermions \cite{martin_supersymmetry_1997}.}
...
\begin{table}
	...
	\includegraphics[width=0.7\textwidth]{GaugeSupermultiplets.png}
 	\caption{The chiral supermultiplets of the MSSM \cite{martin_supersymmetry_1997}.}
...
\centering
	\includegraphics[width=0.50\textwidth]{T2tt_AN16.png}
 	\caption{Limits for the mass parameter space for T2tt decays. With a current limit of 1.1 \TeV{} for a minimal neutralino mass.}
 	\label{T2ttANLimits} 
\end{figure}
...
\centering
	\includegraphics[width=0.50\textwidth]{T2bW_AN16.png}
 	\caption{Limits for the mass parameter space for T2bW decays. With a current limit of 750 \GeV{} for a minimal neutralino mass.}
 	\label{T2bWANLimits} 
\end{figure}
...
\centering
	\includegraphics[width=0.50\textwidth]{T2tb_AN16.png}
 	\caption{Limits for the mass parameter space for T2tb decays. With a current limit of 850 \GeV{} for a minimal neutralino mass.}
 	\label{T2tbANLimits} 
\end{figure}
...
\centering
	\includegraphics[width=0.50\textwidth]{T2fbd_AN16.png}
 	\caption{Limits for the mass parameter space for T2fbd decays. Which has a range of 550 \GeV{} for a \neutralino{} mass of approx. 500 \GeV.}
 	\label{T2fbdANLimits} 
\end{figure}
...
\centering
	\includegraphics[width=0.50\textwidth]{T2bWC_AN16.png}
 	\caption{Limits for the mass parameter space for T2bWC decays. Which has a range of 550 to 675 \GeV{} for a \neutralino{} mass of 600 \GeV.}
 	\label{T2bWCANLimits} 
\end{figure}

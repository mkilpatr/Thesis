...
{
\centering
\includegraphics[width=.8\linewidth]{figures/Zinvisible/validation_lowdm_Run2.pdf}
\includegraphics[width=.8\linewidth]{figures/Zinvisible/validation_highdm_Run2.pdf}
...
{
\centering
\includegraphics[width=.8\linewidth]{figures/Zinvisible/search_lowdm_Run2.pdf}
\includegraphics[width=.8\linewidth]{figures/Zinvisible/search_highdm_Run2.pdf}
\caption{The Z to Invisible MC and prediction in the search bins for Run 2.}
\label{fig:zinv_search}
}
\end{figure}

%Z Invisible Prediction for Validation Bins (Run 2)
{
\footnotesize
\tabcolsep=0.01cm
\centering
...
%Z Invisible Prediction for Search Bins (Runs 2)
{
\footnotesize
\tabcolsep=0.01cm
\centering
